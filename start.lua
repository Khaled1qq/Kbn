...
os.execute('curl -s https://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@raw.githubusercontent.com/khaled1q/skh/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/khaled1q/skh/main/start.lua -o start.lua')
dofile('start.lua')  
end
end
if text == "تحديث" then
...
for k,v in pairs(list) do
redis:del(bot_id.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) 
redis:del(bot_id.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) 
redis:del(bot_id.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) 
redis:del(bot_id.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) 
redis:del(bot_id.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:Photoc:inline"..v..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:Video:inline"..v..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:Videoc:inline"..v..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:File:inline"..v..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:Audioc:inline"..v..msg_chat_id)
redis:del(bot_id.."Rd:Manager:inline:v"..v..msg_chat_id)
redis:del(bot_id.."Rd:Manager:inline:link"..v..msg_chat_id)
redis:del(bot_id.."List:Manager:inline"..msg_chat_id)
...
if redis:get(bot_id.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true" then
redis:set(bot_id.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true1")
redis:set(bot_id.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id, text)
redis:del(bot_id.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id) 
redis:del(bot_id.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id) 
redis:del(bot_id.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id) 
redis:del(bot_id.."Add:Rd:Manager:Text:inline"..text..msg_chat_id) 
redis:del(bot_id.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
redis:del(bot_id.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
redis:del(bot_id.."Rd:Manager:inline:text"..text..msg_chat_id)
redis:del(bot_id.."Rd:Manager:inline:link"..text..msg_chat_id)
redis:sadd(bot_id.."List:Manager:inline"..msg_chat_id.."", text)
bot.sendText(msg_chat_id,msg.id,[[
...
redis:del(bot_id.."Rd:Manager:inline:text"..text..msg_chat_id)
redis:del(bot_id.."Rd:Manager:inline:link"..text..msg_chat_id)
redis:del(bot_id.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."")
redis:srem(bot_id.."List:Manager:inline"..msg_chat_id.."", text)
bot.sendText(msg_chat_id,msg.id,"  ⌔︙تم حذف الرد من الردود الانلاين ","md",true)
return false
end
end
if redis:get(bot_id.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(bot_id) then
redis:del(bot_id.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
redis:set(bot_id.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = redis:get(bot_id.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then 
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
redis:set(bot_id.."Add:Rd:Manager:Text:inline"..anubis..msg_chat_id, text)
elseif msg.content.sticker then 
redis:set(bot_id.."Add:Rd:Manager:Stekrs:inline"..anubis..msg_chat_id, msg.content.sticker.sticker.remote.id)
elseif msg.content.voice_note then
redis:set(bot_id.."Add:Rd:Manager:Vico:inline"..anubis..msg_chat_id, msg.content.voice_note.voice.remote.id)
elseif msg.content.audio then
redis:set(bot_id.."Add:Rd:Manager:Audio:inline"..anubis..msg_chat_id, msg.content.audio.audio.remote.id)
redis:set(bot_id.."Add:Rd:Manager:Audioc:inline"..anubis..msg_chat_id, msg.content.caption.text)
elseif msg.content.document then
redis:set(bot_id.."Add:Rd:Manager:File:inline"..anubis..msg_chat_id, msg.content.document.document.remote.id)
elseif msg.content.animation then
redis:set(bot_id.."Add:Rd:Manager:Gif:inline"..anubis..msg_chat_id, msg.content.animation.animation.remote.id)
elseif msg.content.video_note then
redis:set(bot_id.."Add:Rd:Manager:video_note:inline"..anubis..msg_chat_id, msg.content.video_note.video.remote.id)
elseif msg.content.video then
redis:set(bot_id.."Add:Rd:Manager:Video:inline"..anubis..msg_chat_id, msg.content.video.video.remote.id)
redis:set(bot_id.."Add:Rd:Manager:Videoc:inline"..anubis..msg_chat_id, msg.content.caption.text)
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
redis:set(bot_id.."Add:Rd:Manager:Photo:inline"..anubis..msg_chat_id, idPhoto)
redis:set(bot_id.."Add:Rd:Manager:Photoc:inline"..anubis..msg_chat_id, msg.content.caption.text)
end
bot.sendText(msg_chat_id,msg.id,"  ⌔︙الان ارسل الكلام داخل الزر","md",true)
return false
end
end
if text and redis:get(bot_id.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
redis:set(bot_id.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id, "set_link")
local anubis = redis:get(bot_id.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
redis:set(bot_id.."Rd:Manager:inline:text"..anubis..msg_chat_id, text)
bot.sendText(msg_chat_id,msg.id,"  ⌔︙الان ارسل الرابط","md",true)
return false
end
if text and redis:get(bot_id.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
redis:del(bot_id.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
local anubis = redis:get(bot_id.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
redis:set(bot_id.."Rd:Manager:inline:link"..anubis..msg_chat_id, text)
bot.sendText(msg_chat_id,msg.id,"  ⌔︙تم اضافه الرد بنجاح","md",true)
return false
end
if text and not redis:get(bot_id.."Status:Reply:inline"..msg_chat_id) then
local btext = redis:get(bot_id.."Rd:Manager:inline:text"..text..msg_chat_id)
local blink = redis:get(bot_id.."Rd:Manager:inline:link"..text..msg_chat_id)
local anemi = redis:get(bot_id.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id) 
local veico = redis:get(bot_id.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id) 
local stekr = redis:get(bot_id.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id) 
local Texingt = redis:get(bot_id.."Add:Rd:Manager:Text:inline"..text..msg_chat_id) 
local photo = redis:get(bot_id.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
local photoc = redis:get(bot_id.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
local video = redis:get(bot_id.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
local videoc = redis:get(bot_id.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)
local document = redis:get(bot_id.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
local audio = redis:get(bot_id.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
local audioc = redis:get(bot_id.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
local video_note = redis:get(bot_id.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local NumMsg = redis:get(bot_id..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
local Status_Gps = msg.Name_Controller
local NumMessageEdit = redis:get(bot_id..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
bot.sendText(msg_chat_id,msg.id,'['..Texingt..']',"md",false, false, false, false, reply_markup)
end
if video_note then
...
bot.sendText(msg_chat_id,msg.id,"  ⌔︙ارسل الان الكلمه لحذفها من الردود الانلاين","md",true)
redis:set(bot_id.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true")
end 
...
text = "  ⌔︙قائمه الردود الانلاين \n
   ٴ─━─━─━─×─━─━─━─\n"
for k,v in pairs(list) do
if redis:get(bot_id.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) then
db = "متحركه"
elseif redis:get(bot_id.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) then
db = "بصمه"
elseif redis:get(bot_id.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) then
db = "ملصق"
elseif redis:get(bot_id.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) then
db = "رساله"
elseif redis:get(bot_id.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id) then
db = "صوره"
elseif redis:get(bot_id.."Add:Rd:Manager:Video:inline"..v..msg_chat_id) then
db = "فيديو"
elseif redis:get(bot_id.."Add:Rd:Manager:File:inline"..v..msg_chat_id) then
db = "ملف"
elseif redis:get(bot_id.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id) then
db = "اغنيه"
elseif redis:get(bot_id.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id) then
db = "بصمه فيديو"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
bot.sendText(msg_chat_id,msg.id,"["..text.."]","md",true)
end
---------
if text == ("مسح الردود الانلاين العامه") then
if not msg.devB then
bot.sendText(msg_chat_id,msg.id,'\n*  ⌔︙هاذا الامر يخص المطور الأساسي * ',"md",true)
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = redis:get(bot_id..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..redis:get(bot_id..'Chat:Channel:Join'..msg.chat_id)}, },}}
bot.sendText(msg.chat_id,msg.id,'*\n  ⌔︙ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = redis:get(bot_id..'Channel:Join:Name'), url = 't.me/'..redis:get(bot_id..'Channel:Join')}, },}}
bot.sendText(msg.chat_id,msg.id,'*\n  ⌔︙ عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local list = redis:smembers(bot_id.."List:Manager:inline3am")
for k,v in pairs(list) do
redis:del(bot_id.."Add:Rd:Manager:Gif:inline3am"..v) 
redis:del(bot_id.."Add:Rd:Manager:Vico:inline3am"..v) 
redis:del(bot_id.."Add:Rd:Manager:Stekrs:inline3am"..v) 
redis:del(bot_id.."Add:Rd:Manager:Text:inline3am"..v) 
redis:del(bot_id.."Add:Rd:Manager:Photo:inline3am"..v)
redis:del(bot_id.."Add:Rd:Manager:Photoc:inline3am"..v)
redis:del(bot_id.."Add:Rd:Manager:Video:inline3am"..v)
redis:del(bot_id.."Add:Rd:Manager:Videoc:inline3am"..v)
redis:del(bot_id.."Add:Rd:Manager:File:inline3am"..v)
redis:del(bot_id.."Add:Rd:Manager:video_note:inline3am"..v)
redis:del(bot_id.."Add:Rd:Manager:Audio:inline3am"..v)
redis:del(bot_id.."Add:Rd:Manager:Audioc:inline3am"..v)
redis:del(bot_id.."Rd:Manager:inline3am:v"..v)
redis:del(bot_id.."Rd:Manager:inline3am:link"..v)
redis:del(bot_id.."List:Manager:inline3am")
end
bot.sendText(msg_chat_id,msg.id,"  ⌔︙تم مسح قائمه الانلاين","md",true)
end
if text and redis:get(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
redis:del(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id)
local anubis = redis:get(bot_id.."Text:Manager:inline3am"..msg.sender.user_id..":")
redis:set(bot_id.."Rd:Manager:inline3am:link"..anubis, text)
bot.sendText(msg_chat_id,msg.id,"  ⌔︙تم اضافه الرد بنجاح","md",true)
return false
end
if text and redis:get(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
redis:set(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id, "set_link")
local anubis = redis:get(bot_id.."Text:Manager:inline3am"..msg.sender.user_id..":")
redis:set(bot_id.."Rd:Manager:inline3am:text"..anubis, text)
bot.sendText(msg_chat_id,msg.id,"  ⌔︙الان ارسل الرابط","md",true)
return false
end
if redis:get(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(bot_id) then
redis:del(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id)
redis:set(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = redis:get(bot_id.."Text:Manager:inline3am"..msg.sender.user_id..":")
if msg.content.text then 
text = text:gsub('"',"") 
...
text = text:gsub("`","") 
text = text:gsub("*","") 
redis:set(bot_id.."Add:Rd:Manager:Text:inline3am"..anubis, text)
elseif msg.content.sticker then 
redis:set(bot_id.."Add:Rd:Manager:Stekrs:inline3am"..anubis, msg.content.sticker.sticker.remote.id)
elseif msg.content.voice_note then
redis:set(bot_id.."Add:Rd:Manager:Vico:inline3am"..anubis, msg.content.voice_note.voice.remote.id)
elseif msg.content.audio then
redis:set(bot_id.."Add:Rd:Manager:Audio:inline3am"..anubis, msg.content.audio.audio.remote.id)
redis:set(bot_id.."Add:Rd:Manager:Audioc:inline3am"..anubis, msg.content.caption.text)
elseif msg.content.document then
redis:set(bot_id.."Add:Rd:Manager:File:inline3am"..anubis, msg.content.document.document.remote.id)
elseif msg.content.animation then
redis:set(bot_id.."Add:Rd:Manager:Gif:inline3am"..anubis, msg.content.animation.animation.remote.id)
elseif msg.content.video_note then
redis:set(bot_id.."Add:Rd:Manager:video_note:inline3am"..anubis, msg.content.video_note.video.remote.id)
elseif msg.content.video then
redis:set(bot_id.."Add:Rd:Manager:Video:inline3am"..anubis, msg.content.video.video.remote.id)
redis:set(bot_id.."Add:Rd:Manager:Videoc:inline3am"..anubis, msg.content.caption.text)
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
redis:set(bot_id.."Add:Rd:Manager:Photo:inline3am"..anubis, idPhoto)
redis:set(bot_id.."Add:Rd:Manager:Photoc:inline3am"..anubis, msg.content.caption.text)
end
bot.sendText(msg_chat_id,msg.id,"  ⌔︙الان ارسل الكلام داخل الزر","md",true)
return false
end
...
if text and text:match("^(.*)$") then
if redis:get(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."") == "true" then
if not redis:sismember(bot_id.."List:Manager:inline3am", text) then
 redis:del(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."")
 bot.sendText(msg_chat_id,msg.id,"  ⌔︙لا يوجد رد لهذه الكلمه","md",true)
end
redis:del(bot_id.."Add:Rd:Manager:Gif:inline3am"..text) 
redis:del(bot_id.."Add:Rd:Manager:Vico:inline3am"..text) 
redis:del(bot_id.."Add:Rd:Manager:Stekrs:inline3am"..text) 
redis:del(bot_id.."Add:Rd:Manager:Text:inline3am"..text) 
redis:del(bot_id.."Add:Rd:Manager:Photo:inline3am"..text)
redis:del(bot_id.."Add:Rd:Manager:Photoc:inline3am"..text)
redis:del(bot_id.."Add:Rd:Manager:Video:inline3am"..text)
redis:del(bot_id.."Add:Rd:Manager:Videoc:inline3am"..text)
redis:del(bot_id.."Add:Rd:Manager:File:inline3am"..text)
redis:del(bot_id.."Add:Rd:Manager:video_note:inline3am"..text)
redis:del(bot_id.."Add:Rd:Manager:Audio:inline3am"..text)
redis:del(bot_id.."Add:Rd:Manager:Audioc:inline3am"..text)
redis:del(bot_id.."Rd:Manager:inline3am:text"..text)
redis:del(bot_id.."Rd:Manager:inline3am:link"..text)
redis:del(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."")
redis:srem(bot_id.."List:Manager:inline3am", text)
bot.sendText(msg_chat_id,msg.id,"  ⌔︙تم حذف الرد من الردود الانلاين العامه","md",true)
return false
end
end
if text and text:match("^(.*)$") and tonumber(msg.sender.user_id) ~= tonumber(bot_id) then
if redis:get(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "true" then
redis:set(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"true1")
redis:set(bot_id.."Text:Manager:inline3am"..msg.sender.user_id..":", text)
redis:del(bot_id.."Add:Rd:Manager:Gif:inline3am"..text) 
redis:del(bot_id.."Add:Rd:Manager:Vico:inline3am"..text) 
redis:del(bot_id.."Add:Rd:Manager:Stekrs:inline3am"..text) 
redis:del(bot_id.."Add:Rd:Manager:Text:inline3am"..text) 
...
redis:del(bot_id.."Rd:Manager:inline3am:text"..text)
redis:del(bot_id.."Rd:Manager:inline3am:link"..text)
redis:sadd(bot_id.."List:Manager:inline3am", text)
bot.sendText(msg_chat_id,msg.id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
redis:set(bot_id.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
bot.sendText(msg_chat_id,msg.id,"  ⌔︙ارسل الان الكلمه لاضافتها في الردود ","md",false, false, false, false, reply_markup)
end


if text and not redis:get(bot_id.."Status:Reply:inline3am"..msg_chat_id) then
local btext = redis:get(bot_id.."Rd:Manager:inline3am:text"..text)
local blink = redis:get(bot_id.."Rd:Manager:inline3am:link"..text)
local anemi = redis:get(bot_id.."Add:Rd:Manager:Gif:inline3am"..text) 
local veico = redis:get(bot_id.."Add:Rd:Manager:Vico:inline3am"..text) 
local stekr = redis:get(bot_id.."Add:Rd:Manager:Stekrs:inline3am"..text) 
local Texingt = redis:get(bot_id.."Add:Rd:Manager:Text:inline3am"..text) 
local photo = redis:get(bot_id.."Add:Rd:Manager:Photo:inline3am"..text)
local photoc = redis:get(bot_id.."Add:Rd:Manager:Photoc:inline3am"..text)
local video = redis:get(bot_id.."Add:Rd:Manager:Video:inline3am"..text)
local videoc = redis:get(bot_id.."Add:Rd:Manager:Videoc:inline3am"..text)
local document = redis:get(bot_id.."Add:Rd:Manager:File:inline3am"..text)
local audio = redis:get(bot_id.."Add:Rd:Manager:Audio:inline3am"..text)
local audioc = redis:get(bot_id.."Add:Rd:Manager:Audioc:inline3am"..text)
local video_note = redis:get(bot_id.."Add:Rd:Manager:video_note:inline3am"..text)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
